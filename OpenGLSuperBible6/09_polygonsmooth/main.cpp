...
/** \addtogroup Chapter09*   @{*       \addtogroup polygonsmooth* 允许 GL_POLYGON_SMOOTH 实现多边形平滑.**       @{*/

// #define MANY_CUBES

class polygonsmooth_app : public OpenGLApp
{
public:
	void init()
	{
...
protected:
	...
	{
		program = LoadShadersVF("../media/glsl/09_polygonsmooth.vs", "../media/glsl/09_polygonsmooth.fs");
