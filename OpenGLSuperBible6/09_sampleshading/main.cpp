...
/** \addtogroup Chapter09*   @{*       \addtogroup sampleshading* 通过采样着色实现反锯齿.* *	- GL_SAMPLE_SHADING 采样着色.
*	- glMinSampleShading() 设置采样着色最小的采样率. 每个样本至少采样的次数. 1.0表示每个样本独立着色.*       @{*/

// #define MANY_CUBES

class sampleshading_app : public OpenGLApp
{
public:
	void init()
	{
...
protected:
	...
	{
		program = LoadShadersVF("../media/glsl/09_sampleshading.vs", "../media/glsl/09_sampleshading.fs");
