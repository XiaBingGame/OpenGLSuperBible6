...
/** \addtogroup Chapter09*   @{*       \addtogroup linesmooth* 通过允许 GL_LINE_SMOOTH 实现线的平滑处理.* *       @{*/

#define MANY_CUBES

class linesmooth_app : public OpenGLApp
{
public:
	void init()
	{
...
protected:
	...
	{
		program = LoadShadersVF("../media/glsl/09_linesmooth.vs", "../media/glsl/09_linesmooth.fs");
	...
	virtual void render(double currentTime)
	{
        ...
        for (int i = 0; i < 24; i++)
        {
            ...
            glm::mat4 mv_matrix = glm::translate(glm::mat4(1.0), glm::vec3(0.0f, 0.0f, -20.0f)) *
                                    ...
                                    glm::translate(glm::mat4(1.0), glm::vec3(sinf(2.1f * f) * 2.0f,
                                                     cosf(1.7f * f) * 2.0f,
